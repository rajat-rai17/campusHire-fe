...
import { Pagination, Sorting } from '../../../data/pages/studentNotice'
...
const props = defineProps({
  users: {
    type: Array as PropType<StudentNotice[]>,
    required: true,
  },
...
const emit = defineEmits<{
  (event: 'edit-user', user: StudentNotice): void
  (event: 'delete-user', user: StudentNotice): void
