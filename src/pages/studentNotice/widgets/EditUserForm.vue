...
import { StudentNotice, UserRole } from '../types'
import { validators } from '../../../services/utils'

const props = defineProps({
  user: {
    type: Object as PropType<StudentNotice | null>,
    default: null,
  },
  programData: {
...
const defaultNewUser: StudentNotice = {
  noticeId: 0,
  title: '',
  programs: [],
}

const newUser = ref<StudentNotice>({ ...defaultNewUser })
...
const isFormHasUnsavedChanges = computed(() => {
  return Object.keys(newUser.value).some((key) => {
    ...
    return newUser.value[key as keyof StudentNotice] !== (props.user ?? defaultNewUser)?.[key as keyof StudentNotice]
  })
})
